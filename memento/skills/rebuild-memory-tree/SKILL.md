...
display_name: rebuild-memory-tree
...
Called from memento-core Session Start, or directly by an external scheduler. Check trigger conditions below.
...
5. If root exceeds size cap (default 3000 tokens / ~100 lines): self-compress — compress Historical Summary first, keep Active Context and Topics Index intact
