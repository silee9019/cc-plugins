...
- "별칭 'xxx'을(를) 찾을 수 없습니다" → `teams-fetch list`로 등록된 별칭 확인 권유. 유사 별칭이 있으면 제안됨
...
```bash
node ~/ResilioSync/silee-drive/Repositories/silee9019/cc-plugins/teams-fetch/scripts/cli.mjs add-alias <name> "<teams-url>"
```
